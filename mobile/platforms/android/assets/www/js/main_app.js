...
define('plugins/analytics-helper', 
	[], 
	function(){
    ...
    Analytics.prototype = {
    	...
    	track: function(type, evnt){
            ...
            window.analytics.trackEvent( success, error, type, evnt, "event only", 1);
    	}
    }
...
define('application',[
        ...
        'underscore',
        'plugins/cache',
        'plugins/analytics-helper'
        ,'backbone-wreqr'
    ], 
    function(Backbone, toastr, _, Cache, AnalyticsHelper){
    'use strict';
...
(function (root)
{
	...
	Backbone.WebSQLStore.insertOrReplace = true;
				...
				if (typeof options.filters == 'string') {
					...
					sql += ' WHERE ' + Object.keys(options.filters).map(function(col) {
						if(options.filters[col] instanceof Array){
							params.push(options.filters[col].join(', '));
							debugger;
							return '`' + col + '` IN (?)';	
						}
						else {
	...
	Backbone.WebSQLStore.sync = window.WebSQLStore.sync = Backbone.localSync = function (method, model, options) {
		...
		switch(method) {
			case "read":
				...
				} else if(model.attributes && (columnName = checkAllColumns.call(this, model))) {
					isSingleResult = true;
	...
	var checkAllColumns = function(model){
	...
	{
		define('backbone-websql',['backbone'], factory);
	}
	else
	{
...
'</em>\n	<p>Styrkur is icelandic for strength. And that is just what this app is for.</p>\n	<div class="container-padding">\n		<a class="btn btn-link" href="http://www.styrkurapp.com" target="_blank">Visit us!</a>\n		<a class="btn btn-link" href="#/about/license">3rd party</a></li>\n	</div>\n</div>\n\n<div class="settings-wrapper card">\n	<h3>Settings</h3>\n</div>';
...
var __t, __p = '';
with (obj) {
__p += '<div class="form-group">\n	<label>Session name</label>\n	<input type="text" class="form-control" name="sessionName" placeholder="Name">\n</div>\n\n<div class="form-group">\n	<label>Description</label>\n	<textarea class="form-control" name="description"></textarea>\n</div>\n<div class="form-group">\n	<div class="input-group">\n		<span class="input-group-addon"><i class="icon icon-clock"></i></span>\n		<input type="number" name="estTime" placeholder="Estimated time in minutes" class="form-control">\n		<span class="input-group-addon">min</span>\n	</div>\n</div>\n<div class="form-group clearfix">\n	<button class="btn btn-default pull-right btn-exercises">Exercises</button>\n	<label>Enabled</label>\n	<label class="checkbox-label">\n		<input type="checkbox" name="enabled">\n		<i class="icon icon-check"></i>\n	</label>\n</div>';
...
var __t, __p = '';
with (obj) {
__p += '<div class="form-group">\n    <label for="txtname">Name</label>\n    <input type="text" id="txtname" placeholder="Name" name="name" class="form-control" >\n</div>\n<div class="form-group">\n    <button class="btn btn-primary btn-create">Next</button>\n	<a class="btn btn-link" href="#/plan">Cancel</a>\n</div>\n';
...
__p += '\n</div>\n<div class="sets-list">\n</div>\n<div class="clearfix">\n	<button class="pull-right btn btn-default btn-add-set">Add extra set</button>\n</div>\n';
...
__p += '\n</div>\n<div class="exercise-list">\n</div>\n\n<div class="card">\n	<label>Comment</label>\n	<textarea name="comment" class="form-control"></textarea>\n\n	<div class="container-padding">\n		<button class="btn btn-primary btn-save">Complete</button>\n		<a class="btn btn-link" href="#/workout/">Close</a>\n	</div>\n</div>\n\n<div class="welldone-box">\n	<i class="icon icon-check"></i>\n	<h1>Good job!</h1>\n	<h2>You lifted <span class="weight-lifted"></span></h2>\n</div>';
...
var __t, __p = '';
with (obj) {
__p += '<div class="view-header">\n	<h2>Add part</h2>\n</div>\n\n<div class="card">\n	<div class="form-group">\n		<label>Name</label>\n		<input type="text" name="name" class="form-control">\n	</div>\n	<div class="form-group">\n		<label>Description</label>\n		<textarea name="description" class="form-control"></textarea>\n	</div>\n	<div class="form-group">\n		<label>Unit type</label>\n		<select name="unittype" class="form-control">\n			<option value="weight">Weight</option>\n			<option value="percent">Percent</option>\n			<option value="shortLength">Short length</option>\n			<option value="longLength">Long length</option>\n		</select>\n	</div>\n\n	<div class="clearfix">\n		<button class="btn btn-primary btn-save"><i class="icon icon-plus"></i> Add</button><a href="#/measurements/" class="btn btn-link">Cancel</a>\n	</div>\n</div>';
...
__p += '\n';
 if(noData){ ;
__p += '\n	<p>You need atleast two measurements</p>\n	';
 if(lastOne){ ;
__p += '\n	<p>Last one was ' +
((__t = ( lastOne )) == null ? '' : __t) +
' at ' +
((__t = ( lastDate )) == null ? '' : __t) +
'</p>\n	';
 } ;
__p += '\n';
} else {;
...
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class="view-header">\n	<h1>Measurements</h1>\n\n	<div class="clearfix">\n		<a href="#/measurements/add" class="btn btn-default pull-right"><i class="icon icon-plus"></i> Measure</a>\n		<a href="#/measurements/addpart" class="btn btn-default pull-right"><i class="icon icon-plus"></i> Add part</a> \n	</div>\n</div>\n\n<!-- If there are no measurements.. -->\n';
 if(noData){ ;
__p += '\n<div class="card">\n	<p>You dont seem to have any measurements registered. Do you want to register one now?</p>\n\n	<div class="clearfix">\n		<a href="#/measurements/add" class="btn btn-primary pull-right"><i class="icon icon-plus"></i> Measure</a>\n	</div>\n</div>\n';
} else {;
...
var __t, __p = '';
with (obj) {
__p += '<div class="view-header">\r\n	<h1>Workout planner</h1>\r\n</div>\r\n\r\n<div class="workout-list">\r\n</div>\r\n\r\n<div class="card">\r\n    <a class="btn btn-primary pull-right" href="#/plan/list">Get more..</a>\r\n    <a class="btn btn-default" href="#/create/workout">Create routine</a>\r\n</div>\r\n';
...
var __t, __p = '';
with (obj) {
__p += '<div class="workout-table"></div>\n\n<div class="card">\n    <a class="btn btn-default" href="#/plan">Back</a>\n</div>\n\n';
...
((__t = ( id )) == null ? '' : __t) +
'"><i class="icon icon-pen"></i> Edit</a>\n<h3>' +
((__t = ( name )) == null ? '' : __t) +
'</h3>\n<p class="pre">' +
((__t = ( description )) == null ? '' : __t) +
'</p>\n<div>\n	';
 if(!currentWorkout || currentWorkout !== id){ ;
__p += '\n		<button class="btn btn-primary btn-use-item">Set as current</button>\n	';
 } else { ;
...
__p += '<h4>Set ' +
((__t = (index)) == null ? '' : __t) +
'</h4>\n<div class="form-group type-reps">\n	<label>Reps</label><input type="number" value="" class="form-control input-reps" placeholder="' +
...
define('base/base-view',['jquery', 'backbone'], 
    function($, Backbone){
    'use strict';
...
define('base/parent-view',['jquery', 'backbone', 'base/base-view'], 
...
define('views/dashboard',
    ...
    var view = BaseView.extend({
    	...
    	render: function(){
            ...
            App.analytics.track(App.analytics.types.nav, "Dashboard");
